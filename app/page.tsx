            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Murder Case Analysis меняет представление о том, как мы понимаем судебные решения по делам об убийствах в России. Используя передовые методы текстового анализа, платформа позволяет загружать файлы судебных решений для углубленного изучения. Документы обрабатываются в облаке с применением сложной языковой модели (LLM) для извлечения ключевых признаков. Четкие и понятные таблицы предоставляют ценные инсайты, повышающие юридическую осведомленность и способствующие справедливости в Химках и за их пределами.
                </p>
                <Link 
                  href="#contact" 
